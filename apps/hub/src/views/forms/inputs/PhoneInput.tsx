...
export const PhoneInput = forwardRef((props: { onChange: (value: string) => void, value: string }, ref) => {
  ...
  return (
    <div className="select-none border p-2 rounded flex font-mono text-sm hover:cursor-text focus:border-black shadow-sm bg-white w-full" tabIndex={0} ref={setRefs}>
