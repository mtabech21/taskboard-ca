...
import { AssociateAccount, Branch, ManagerAccount, NewAssociateForm } from "@taskboard/types";
...
export function useNewAssociateForm(account: ManagerAccount) {
  ...
  async function handler(): Promise<void> {
    ...
    console.log(values)
    await api.post<NewAssociateForm, AxiosResponse<AssociateAccount>>('/payroll/associates/new', values);
    toast(
      <>
