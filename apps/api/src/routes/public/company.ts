...
company
  ...
  .get(async (req, res) => {
    ...
    const badges = db.tx([associates, accounts],
...
company
  ...
  .post(async (req, res, next) => {
    ...
    const company = db.tx([companies, accounts, branches, positions, associates],
      async ([companies, accounts, branches, positions, associates]) => {
        ...
        await associates.insert({ id: user_id, badge_number: '000000', company_id, branch_id, first_name, last_name, position_id })
